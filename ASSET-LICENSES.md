...
| Jelto mascot and favicon | `web/vendor/brand/` | Subject to [the Jelto brand notice](web/vendor/brand/NOTICE.txt); excluded from MIT and other software open-source licenses. No trademark or reuse permission is granted by inclusion in this repository. |
