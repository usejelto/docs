---
title: "Custom tracking domain with Cloudflare DNS"
group: integrations
slug: subdomain/cloudflare
...
DNS reference: [Official Cloudflare DNS documentation](https://developers.cloudflare.com/dns/proxy-status/).
