...
group: install
slug: install/lovable
summary: "Add Jelto to a Lovable project with a focused prompt and verify the deployed site."
---

# Install on Lovable

Connect your Lovable website by adding the script to the application's shared document. The builder's own traffic analytics and Jelto are separate tools.
...
1. Open the existing project. Ask Lovable to update the existing app, then review the file change before publishing.
...
Platform reference: [Official Lovable documentation](https://docs.lovable.dev/features/analytics).
