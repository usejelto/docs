...
Choose the metric you use to judge the product. Changing this selection changes the overview's emphasis, not how events are collected.
...
Visitors helps with audience growth; a signup goal helps with acquisition; active or retained installs helps with continued app use. Revenue requires a connected provider or verified custom payment integration.

A selected metric can remain unavailable if collection, history or sample requirements are not met. That state is not a zero and changing the KPI does not manufacture the missing data.
