...
group: install
slug: install/framer
summary: "Add Jelto to your Framer website and verify the published pages."
---

# Install on Framer

Measure visits to your Framer website using the script from your Jelto product.
...
1. Open **Project Settings → Custom Code → Add Script** (or **+**). Name it Jelto, use a head placement, apply it to all relevant pages, paste the tag and choose **Once**.
...
The tracker installs its own navigation listeners. Choosing Run on every page visit for installation can repeatedly install those listeners. Verify a second page and Back navigation.
...
Platform reference: [Official Framer documentation](https://www.framer.com/help/articles/how-to-add-custom-code/).
