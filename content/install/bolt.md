...
group: install
slug: install/bolt
summary: "Add Jelto to a Bolt project with a focused prompt and verify the deployed site."
---
...
1. Open the existing project. Use the chat to request the change, or open Code View to edit the shared document directly.
...
Platform reference: [Official Bolt documentation](https://support.bolt.new/cloud/hosting/analytics).
